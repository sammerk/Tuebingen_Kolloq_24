...
::: footer
{{< iconify academicons:open-materials >}} Folien cc-by {{< iconify academicons:creative-commons-by >}} unter [https://bit.ly/merk123](https://bit.ly/merk123)
:::
...
::: {.column width='45%'}
::: {.fragment}
![Enge und weite Evidenzbegriffe nach @schmidt2024](img/EvidenzbegriffeSchmidt.png)
:::
:::
...
::: {.incremental}
* Lebendige Diskussion um ***Replizierbarkeit*** in Sozialwissenschaften, Biomedizin & (Verhaltens-)Ökonomie seit Anfang der 2010er [@ritchie2020]
